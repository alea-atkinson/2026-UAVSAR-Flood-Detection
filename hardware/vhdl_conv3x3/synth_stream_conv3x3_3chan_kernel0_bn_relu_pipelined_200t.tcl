# Vivado batch synthesis for the PIPELINED kernel-0 folded Conv-BN-ReLU
# proof-of-concept (stream_conv3x3_3chan_kernel0_bn_relu_pipelined).
...
# synth_stream_conv3x3_3chan_kernel0_bn_relu_200t.tcl (the unpipelined
# design's synthesis script). This design reuses the existing, unmodified
# stream_conv3x3_3chan_cell.vhd / conv3x3_dot_pipelined.vhd /
# window3x3_stream.vhd and the existing, unmodified
# first_conv_bn_relu_kernel0_pkg.vhd, plus the new
# stream_conv3x3_3chan_kernel0_bn_relu_pipelined.vhd.

set part_name "xc7a200tsbg484-1"
set top_name "stream_conv3x3_3chan_kernel0_bn_relu_pipelined"
set report_dir "hardware/vhdl_conv3x3/vivado_reports_kernel0_bn_relu_pipelined_200t"
...
read_vhdl -vhdl2008 hardware/vhdl_conv3x3/first_conv_bn_relu_kernel0_pkg.vhd
read_vhdl -vhdl2008 hardware/vhdl_conv3x3/stream_conv3x3_3chan_kernel0_bn_relu_pipelined.vhd
