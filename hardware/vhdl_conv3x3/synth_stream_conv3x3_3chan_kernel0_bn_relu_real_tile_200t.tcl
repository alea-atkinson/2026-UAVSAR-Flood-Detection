# Vivado batch synthesis for the REAL-TILE Q.16 kernel-0 folded
# Conv-BN-ReLU design (stream_conv3x3_3chan_kernel0_bn_relu_real_tile).
...
# first_conv_bn_relu_kernel0_real_tile_pkg.vhd (Q.16 SCALE_FX, computed
# from a genuine real per-tile activation scale, not the toy patch's
# exact 1.0) and stream_conv3x3_3chan_kernel0_bn_relu_real_tile.vhd.
#
# Companion to synth_stream_conv3x3_3chan_kernel0_bn_relu_real_tile_q20_200t.tcl
# (Q.20 variant) -- this pair is the Q.16-vs-Q.20 synthesis comparison.

set part_name "xc7a200tsbg484-1"
set top_name "stream_conv3x3_3chan_kernel0_bn_relu_real_tile"
set report_dir "hardware/vhdl_conv3x3/vivado_reports_kernel0_bn_relu_real_tile_200t"
...
read_vhdl -vhdl2008 hardware/vhdl_conv3x3/first_conv_bn_relu_kernel0_real_tile_pkg.vhd
read_vhdl -vhdl2008 hardware/vhdl_conv3x3/stream_conv3x3_3chan_kernel0_bn_relu_real_tile.vhd
