...
#
# Mirrors synth_stream_conv3x3_3chan_16out_cell_dsp_200t.tcl (same clock,
# same out-of-context synthesis style, same report set) so results are
# directly comparable to the existing 8-output and 16-output DSP-aware
# results on this target. The only functional difference in the design
# under test is the output-channel count (24 kernels vs. 16/8);
# conv3x3_dot_pipelined_dsp.vhd is unchanged.

set part_name "xc7a200tsbg484-1"
set top_name "stream_conv3x3_3chan_24out_cell_dsp"
set report_dir "hardware/vhdl_conv3x3/vivado_reports_24out_dsp_200t"
