# Vivado batch synthesis for the REAL-TILE Q.20 kernel-2 folded
# Conv-BN-ReLU design (stream_conv3x3_3chan_kernel2_bn_relu_real_tile_q20).
...
# stream_conv3x3_3chan_kernel2_bn_relu_real_tile.vhd (Q.16) -- same
# stream_conv3x3_3chan_cell sub-component, same two-stage pipeline; only
# the constants package differs (first_conv_bn_relu_kernel2_real_tile_q20_pkg,
# Q.20 SCALE_FX/BIAS_FX). This is the Q.20 half of the Q.16-vs-Q.20
# synthesis comparison; see
# synth_stream_conv3x3_3chan_kernel2_bn_relu_real_tile_200t.tcl for the
# Q.16 half.

set part_name "xc7a200tsbg484-1"
set top_name "stream_conv3x3_3chan_kernel2_bn_relu_real_tile_q20"
set report_dir "hardware/vhdl_conv3x3/vivado_reports_kernel2_bn_relu_real_tile_q20_200t"
...
read_vhdl -vhdl2008 hardware/vhdl_conv3x3/first_conv_bn_relu_kernel2_real_tile_q20_pkg.vhd
read_vhdl -vhdl2008 hardware/vhdl_conv3x3/stream_conv3x3_3chan_kernel2_bn_relu_real_tile_q20.vhd
