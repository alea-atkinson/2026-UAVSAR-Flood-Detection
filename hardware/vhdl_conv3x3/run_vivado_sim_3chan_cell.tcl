# run_vivado_sim_3chan_cell.tcl
# Vivado batch-mode simulation for stream_conv3x3_3chan_cell.
#
# ---- Usage (batch mode) --------------------------------------------------
#   cd hardware/vhdl_conv3x3
#   vivado -mode batch -source run_vivado_sim_3chan_cell.tcl
#
# ---- Usage (xvhdl/xelab/xsim directly) ----------------------------------
#   source /opt/Xilinx/Vivado/2024.2/settings64.sh
#   cd hardware/vhdl_conv3x3
#   xvhdl --2008 window3x3_stream.vhd conv3x3_dot_pipelined.vhd \
#               stream_conv3x3_3chan_cell.vhd tb_stream_conv3x3_3chan_cell.vhd
...
puts ""
puts "=== stream_conv3x3_3chan_cell Vivado Simulation ==="
...
add_files -fileset sim_1 -norecurse ${script_dir}/tb_stream_conv3x3_3chan_cell.vhd
set_property file_type              {VHDL 2008} [get_files tb_stream_conv3x3_3chan_cell.vhd]
set_property used_in_synthesis      false        [get_files tb_stream_conv3x3_3chan_cell.vhd]
set_property used_in_implementation false        [get_files tb_stream_conv3x3_3chan_cell.vhd]

set_property top     tb_stream_conv3x3_3chan_cell [get_filesets sim_1]
