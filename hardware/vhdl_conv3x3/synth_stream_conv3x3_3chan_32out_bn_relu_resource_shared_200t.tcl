...
# but this specific synthesis run is of the SMALLEST SERIOUS IMPLEMENTED
# PROTOTYPE: a resource-shared (time-multiplexed) folded Conv-BN-ReLU
# design covering 4 of 32 first-layer output channels (kernels 0-3),
# reusing ONE dot-product engine (conv3x3_dot_time_mux) and ONE Q.16
# fixed-point BN+ReLU unit across all 4 kernels and all 9 window
# positions of the canonical 5x5x3 toy input -- NOT a claim that the full
# 32-kernel resource-shared design has been synthesized.
#
