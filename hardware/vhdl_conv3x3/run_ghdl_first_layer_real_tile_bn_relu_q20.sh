...
# Simulate tb_stream_conv3x3_3chan_first_layer_real_tile_bn_relu_q20 using GHDL.
#
...
#   first_conv_bn_relu_kernel0_real_tile_q20_pkg.vhd             (new)
#   first_conv_bn_relu_kernel2_real_tile_q20_pkg.vhd             (new)
#   stream_conv3x3_3chan_kernel0_bn_relu_real_tile_q20.vhd       (new)
#   stream_conv3x3_3chan_kernel2_bn_relu_real_tile_q20.vhd       (new)
#   tb_stream_conv3x3_3chan_first_layer_real_tile_bn_relu_q20.vhd (new)
#
# Usage:
...
#   ...
#   === REAL-TILE Q.20-format first-layer Conv-BN-ReLU verification summary ===
...
#   === All tb_stream_conv3x3_3chan_first_layer_real_tile_bn_relu_q20 tests PASSED ===
#
...
EXTRA_RUN_FLAGS=""
if [[ "${1:-}" == "--vcd" ]]; then
    EXTRA_RUN_FLAGS="--vcd=tb_stream_conv3x3_3chan_first_layer_real_tile_bn_relu_q20.vcd"
    echo "Waveform: tb_stream_conv3x3_3chan_first_layer_real_tile_bn_relu_q20.vcd  (open with GTKWave)"
elif [[ "${1:-}" == "--wave" ]]; then
    EXTRA_RUN_FLAGS="--wave=tb_stream_conv3x3_3chan_first_layer_real_tile_bn_relu_q20.ghw"
    echo "Waveform: tb_stream_conv3x3_3chan_first_layer_real_tile_bn_relu_q20.ghw"
fi
...
ghdl -a --std=08 tb_stream_conv3x3_3chan_first_layer_real_tile_bn_relu_q20.vhd
echo "  OK  tb_stream_conv3x3_3chan_first_layer_real_tile_bn_relu_q20.vhd"
echo ""

echo "=== [2/3] Elaborating tb_stream_conv3x3_3chan_first_layer_real_tile_bn_relu_q20 ==="
ghdl -e --std=08 tb_stream_conv3x3_3chan_first_layer_real_tile_bn_relu_q20
echo "  OK"
echo ""
...
ghdl -r --std=08 tb_stream_conv3x3_3chan_first_layer_real_tile_bn_relu_q20 \
    --stop-time=1000ns \
