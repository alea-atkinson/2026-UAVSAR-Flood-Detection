...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--train-csv", type=Path, default="csv_organized_tiles/Only_PNG_Data/fb_nonoverlap_splits/target_05_10_percent/train.csv")
    parser.add_argument("--val-csv", type=Path, default= "csv_organized_tiles/Only_PNG_Data/fb_nonoverlap_splits/target_05_10_percent/val.csv")
    parser.add_argument("--test-csv", type=Path, default="csv_organized_tiles/Only_PNG_Data/fb_nonoverlap_splits/target_05_10_percent/test.csv")
...
def main() -> None:
    ...
    visual_path = args.visuals_dir / f"{args.run_name}_test_sample5.png"
