...
OUT_DIR = REPO_ROOT / "hardware" / "vhdl_conv3x3" / "test_vectors" / f"conv_bn_relu_kernel{K}"
JSON_PATH = OUT_DIR / f"kernel{K}_bn_relu_fixed_point_vectors.json"
CSV_PATH  = OUT_DIR / f"kernel{K}_bn_relu_fixed_point_vectors.csv"
MD_PATH   = OUT_DIR / f"kernel{K}_bn_relu_fixed_point_summary.md"
PKG_PATH  = REPO_ROOT / "hardware" / "vhdl_conv3x3" / f"first_conv_bn_relu_kernel{K}_pkg.vhd"
...
md_lines = f"""\
# Kernel {K} Folded Conv-BN-ReLU -- Fixed-Point Test Vectors

Generated by `scripts/generate_bn_relu_fixed_point_vectors.py --kernel-id {K}`.
...
pkg_name = f"first_conv_bn_relu_kernel{K}_pkg"
...
--
-- Generated by: scripts/generate_bn_relu_fixed_point_vectors.py --kernel-id {K}
-- Source data : hardware/vhdl_conv3x3/test_vectors/conv_bn_relu_kernel{K}/kernel{K}_bn_relu_fixed_point_vectors.json
--
-- ---- Source of weights --------------------------------------------------
-- Checkpoint : {CHECKPOINT_PATH.relative_to(REPO_ROOT)}
